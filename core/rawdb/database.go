...
import (
	...
	"github.com/ava-labs/libevm/internal/tablewriter"
...
// Add records an additional size measurement (see [DatabaseStat]).
func (s *stat) Add(size common.StorageSize) {
	s.add(size)
}

// Size returns the accumulated size as a human-readable string.
func (s *stat) Size() string {
	return s.sizeString()
}

// Count returns the number of [stat.Add] calls as a decimal string.
