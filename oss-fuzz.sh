...
coverpkg="github.com/ava-labs/libevm/..."
...
repo=$GOPATH/src/github.com/ava-labs/libevm
compile_fuzzer github.com/ava-labs/libevm/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/ava-labs/libevm/common/bitutil \
...
compile_fuzzer github.com/ava-labs/libevm/eth/protocols/snap \
...
compile_fuzzer github.com/ava-labs/libevm/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/ava-labs/libevm/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/ava-labs/libevm/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/ava-labs/libevm/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/ava-labs/libevm/eth/protocols/eth \
